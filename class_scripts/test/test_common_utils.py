...
class Test_validate_dir_lesson_args(hunitest.TestCase):
    ...
    def test2(self) -> None:
        ...
        lesson_arg = "01.1"
        # Prepare outputs.
        expected_error_msg = "DIR argument cannot be empty"
        # Run test.
    ...
    def test3(self) -> None:
        ...
        lesson_arg = ""
        # Prepare outputs.
        expected_error_msg = "LESSON argument cannot be empty"
        # Run test.
        with self.assertRaises(AssertionError) as cm:
            csccouti.validate_dir_lesson_args(dir_arg, lesson_arg)
        # Check outputs.
...
class Test_find_lecture_file(hunitest.TestCase):
    ...
    def test1(self) -> None:
        ...
        """
        # Prepare inputs.
        dir_path = self._create_lecture_source_dir(
    ...
    def test2(self) -> None:
        ...
        # Prepare outputs.
        expected_error_msg = "Expected exactly one file"
        # Run test.
        with self.assertRaises(AssertionError) as cm:
    ...
    def test3(self) -> None:
        ...
        # Prepare inputs.
        dir_path = self._create_lecture_source_dir(
            ["Lesson01-First.txt", "Lesson01-Second.txt"]
        )
        # Prepare outputs.
        expected_error_msg = "Expected exactly one file"
        # Run test.
...
class Test_get_output_name(hunitest.TestCase):
    ...
    def _helper(
        self, source_name: str, extension: str, expected: str
    ) -> None:
        """
...
class Test_count_pdf_pages(hunitest.TestCase):
    ...
    def test2(self) -> None:
        ...
        # Prepare outputs.
        expected_error_msg = "Unexpected mdls output format"
        # Run test.
        with mock.patch(
            "helpers.hsystem.system_to_string", return_value=mdls_output
        ):
