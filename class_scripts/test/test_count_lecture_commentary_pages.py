"""
Unit tests for count_lecture_commentary_pages.py.
...
import class_scripts.count_lecture_commentary_pages as clclecopa
...
class Test_main(hunitest.TestCase):
    ...
    def test1(self) -> None:
        ...
        `{dir}/book` directory and results are logged.
        """
        # Prepare inputs.
