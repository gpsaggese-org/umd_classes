...
- From the root of the repository:
  ```bash
  > cd tutorials/explainability_shap_lime
  > ./docker_build.sh
  > ./docker_jupyter.sh
  ```
...
- This tutorial includes all the code, notebooks, and Docker container in
  [tutorials/explainability_shap_lime](https://github.com/gpsaggese/umd_classes/tree/master/tutorials/explainability_shap_lime):
