...
import tutorials.BambooAI.bambooai.models.groq_models as tbbmgrmo
"""
                ...
                if chunk.choices and len(chunk.choices) > 0:
                    ...
                    if delta and delta.content is not None:
                        ...
                        output_manager.print_wrapper(
                            chunk_message, end="", flush=True, chain_id=chain_id
                        )
            ...
            for tool_call in tool_calls:
                ...
                if not function_to_call:
                    output_manager.display_system_messages(
                        f"Warning: Unknown function {function_name}"
                    )
                    continue
