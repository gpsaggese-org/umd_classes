...
import tutorials.BambooAI.bambooai.models.deepseek_models as tbbmdemo
"""
...
def llm_stream(
    ...
    available_functions = {"google_search": google_search_function}
    ...
    for chunk in response:
        ...
        if delta and hasattr(delta, "content") and delta.content:
            ...
            output_manager.print_wrapper(
                delta.reasoning_content, end="", flush=True, chain_id=chain_id
            )
    ...
    completion_tokens_used = len(
        encoding.encode(full_reply_content + reasoning_content)
    )
