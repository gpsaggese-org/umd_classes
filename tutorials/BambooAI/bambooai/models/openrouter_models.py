...
import tutorials.BambooAI.bambooai.models.openrouter_models as tbbmopmo
"""
...
def llm_stream(
    ...
    def get_response(
        ...
        if reasoning_models and model in reasoning_models:
            output_manager.display_tool_info(
                "Thinking",
                f"Model {model} needs a moment to think...",
                chain_id=chain_id,
            )
    ...
    for chunk in response:
        ...
        if delta and hasattr(delta, "content") and delta.content:
            ...
            output_manager.print_wrapper(
                delta.reasoning, end="", flush=True, chain_id=chain_id
            )
