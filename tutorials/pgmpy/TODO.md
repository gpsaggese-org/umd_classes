...
# [ ] Create more notebooks based on the user manual
  ...
  - All the notebooks are
    ...
    - [Causal Estimation](https://pgmpy.org/guides/causal_estimation.html)
    - [Metrics](https://pgmpy.org/guides/metrics.html)
    - [Example Datasets](https://pgmpy.org/guides/datasets.html)
    - [Example Models](https://pgmpy.org/guides/example_models.html)
    - [Simulations](https://pgmpy.org/guides/simulations.html)
    - [Exporting / Importing Models](https://pgmpy.org/guides/io.html)
    - [Defining a Custom Model](https://pgmpy.org/guides/custom_model.html)
