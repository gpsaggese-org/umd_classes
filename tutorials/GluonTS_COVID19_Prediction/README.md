...
This directory is a hands-on GluonTS tutorial: synthetic fundamentals in
`GluonTS.API.ipynb`, a full COVID-19 forecasting pipeline in
`GluonTS.example.ipynb`, shared code in `GluonTS_utils.py`, and Docker scripts
for reproducible Jupyter. The README below explains setup, data, and layout.
