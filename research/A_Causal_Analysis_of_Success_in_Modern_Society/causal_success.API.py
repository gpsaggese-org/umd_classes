...
#
# You can think of this notebook as getting familiar with the individual tools before using them together in a full workflow.
#
...
# **descriptive analysis** to **causal and Bayesian inference**.
#
...
#
# Let’s create one simulated person and take a quick look at their starting traits and stats.
#
...
#
# Over many periods, this compounding effect can produce large differences in outcomes, even when agents start with identical resources and similar abilities.
#
...
#
# At this point, all agents still have exactly \$1.00 in capital. There is variation in *potential* (talents), but no variation in *outcomes* yet. Any inequality that appears later will be the result of how random events interact with these talents over time, not differences in starting wealth.
#
...
#
# This function returns all the key quantities you would typically report: inequality measures, distributional statistics, and average event counts. It provides a quick snapshot of how the system evolved and is especially useful when comparing multiple simulation runs or policy scenarios.
#
...
#
# While this step does not change the results, it provides confidence that the simulation outputs are internally consistent and safe to use for statistical and causal analysis.
#
...
#
# Even in short simulations, these plots often reveal early signs of skewness, with a small number of agents pulling ahead while others fall behind. This visual perspective complements the numerical inequality measures shown earlier.
#
...
# ```
#
# The returned dictionary contains `"y_obs"` (observed log-capital),
...
# useful for checking how well the model captures the distribution of outcomes.
