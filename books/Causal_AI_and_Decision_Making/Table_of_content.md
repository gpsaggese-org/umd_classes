...
// Lesson08.5-Causal_AI_In_Business.txt
...
// Lesson08.1-Causal_AI_intro.txt, Lesson08.2-Causal_Networks.txt, Lesson08.3-Do_Calculus.txt
- A: Mathematical foundations of causal inference
// Lesson08.2-Causal_Networks.txt
- B: DAG notation, d-separation rules, and identification algorithms
// Lesson08.2-Causal_Networks.txt, Lesson08.3-Do_Calculus.txt
- C: Potential outcomes framework reference
// Lesson07.1-Intro_to_Probabilistic_Programming.txt, Lesson07.2-Posterior_Based_Decisions.txt, Lesson07.3-Hierarchical_Models.txt, Lesson07.4-Generalized_Linear_Models.txt, Lesson07.5-Bayesian_Model_Comparison.txt
...
// Lesson10-Timeseries_forecasting.txt, Lesson96.Refresher_stochastic_processes.txt
