...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:23 '* From Data Science to Decision Science'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:46 '* Causal vs Predictive Questions'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:70 '* The Analytics Maturity Ladder'
...
industry lives, forecasting what will happen next from historical patterns Level~2
...
purely predictive pipeline never needed. Level~3 closes the loop by combining a causal
...
The jump from Level~1 to Levels~2 and~3 is not an incremental improvement in model
accuracy; it is a change in what kind of question the pipeline is built to
answer at all. Level~2 requires being explicit about the causal structure connecting
actions to outcomes, structure a purely predictive model never needs to
represent, let alone get right. Level~3 requires, in addition, an explicit
...
proxy metric happened to be easiest to log. Climbing to Levels~2 and~3 is the
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:94 '# The Cost of Ignoring Causality'
\section{The Cost of Ignoring Causality}
\label{chap:cost-ignoring-causality}

% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:96 '## When Correlation Misleads'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:98 '* Correlation Encodes Confounding as Causation'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:140 '* Missing Interventions and Counterfactuals'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:160 '* Selection Bias and the Missing Counterfactual'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:178 '## Structural Failure Modes'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:180 '* Interference and Spillovers Across Units'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:197 '* Simpson's Paradox: When Aggregates Lie'
...
is exactly the number a Level~0 dashboard would surface: an overall recovery
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:247 '* Collider Bias: Conditioning Creates Illusions'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:267 '* Discarding Domain Knowledge and Mechanism'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:304 '# The Cost of Ignoring Uncertainty'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:306 '* Point Estimates Without Error Bars'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:326 '* Epistemic vs Aleatoric Uncertainty Conflated'
...
stochastic \emph{Epistemic} uncertainty, by contrast, comes from not having seen
enough data, or from using the wrong model; it reflects what the model does not yet
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:349 '* No Abstention: Systems That Never Say "I Don't Know"'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:363 '* Overfitting and the Statistical Significance Traps'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:380 '# The Cost of Ignoring the Business Objective'
\section{The Cost of Ignoring the Business Objective}
\label{chap:cost-ignoring-business-objective}

% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:382 '## Proxies, Costs, and Trade-offs'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:384 '* Optimizing the Wrong Objective'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:401 '* Symmetric Losses for Asymmetric Errors'
...
the loss function bakes a mismatch into the model from the start
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:423 '* Multi-Objective Decisions Under Constraints'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:439 '## From Scores to Actionable Decisions'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:441 '* Black-Box Scores Are Not Recommendations'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:462 '* The Cost of Solving Sub-Problems Separately'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:480 '# The Cost of Ignoring Dynamics and Feedback'
\section{The Cost of Ignoring Dynamics and Feedback}
\label{chap:cost-ignoring-dynamics-feedback}

% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:482 '## A World That Reacts'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:484 '* The Static-World Assumption Breaks'
...
A fraud model trained on last year's fraud rate illustrates the danger of the
third kind. As attackers adopt new tactics, the base rate and pattern of fraud
shifts, a label shift the model has no built-in way to detect on its own, since
the model only knows the fraud patterns it was shown during training and has no
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:514 '* Feedback Loops and Bias Amplification'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:535 '* Performativity: When the Prediction Changes the Outcome'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:552 '## Missing Exploration and Long Horizons'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:554 '* No Exploration: Trapped in the Logged Policy'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:569 '* Delayed and Long-Horizon Effects'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:590 '* Strategic and Adversarial Response'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:608 '# Why This Matters'
\section{Why This Matters}
\label{chap:why-this-matters}

% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:610 '## Roadmap'
\subsection{Roadmap}
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:612 '* Why AI Projects Fail'
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:626 '* Four Costs, One Root Cause'
\textbf{Four Costs, One Root Cause} --- The four costs surveyed across this
...
% From: book_springer/lectures_source/Lesson02.1_From_Data_Science_To_Decision_Science.smd:657 '* Roadmap: Where the Book Goes From Here'
\textbf{Roadmap: Where the Book Goes From Here} --- This lesson has catalogued
what a purely predictive pipeline misses: causal mechanism, calibrated
uncertainty, an explicit business objective, and an accounting for the dynamics
a decision sets off. The rest of the book builds the pipeline that does not miss
these things, organized into four parts that build on one another
...
predictive pipeline lacks. Part~III then shows how to use that machinery to make
a single decision well, choosing one action under known uncertainty and a stated
objective. Part~IV relaxes the single-step assumption, since most real decisions
are not made once and forgotten but repeated over time in a world that reacts,
exactly the dynamics surveyed in Chapter~\ref{chap:cost-ignoring-dynamics-feedback}
