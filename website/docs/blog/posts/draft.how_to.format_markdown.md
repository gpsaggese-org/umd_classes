...
> lint_text.py -h
usage: lint_text.py [-h] [-i INPUT] [-o OUTPUT] [--input_files INPUT_FILES [INPUT_FILES ...]] [--from_file FROM_FILE] [--type TYPE] [-w WIDTH] [--backend {prettier,mdformat,flowmark}] [--mode MODE] [--use_dockerized_prettier] [--no_use_dockerized_prettier]
