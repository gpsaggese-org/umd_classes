...
- Code needs to be organized in layers
- Related code needs to be close to each other
- Functions that are private needs to be indicated as such
- Convert big chunks of code in a sequence of functions

.claude/skills/architecture.rules.md
.claude/templates/architecture_doc.template.md

- You should have a nice diagram

./.claude/skills/readme.write_architecture
