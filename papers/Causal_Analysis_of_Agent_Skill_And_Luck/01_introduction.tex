...
\begin{abstract}
  ...
  We develop a complete mathematical framework for decomposing
  ...
  philosophy's treatment of responsibility and what is deserved. And it supplies
  the tools necessary for evaluating whether our institutions reward
  skill or merely reinforce the accidents of birth and circumstance.
...
% TODO(ai_gp): Convert into bullet points
To what extent do observed inequalities reflect
...
Existing approaches often conflate luck with randomness.
We propose that \emph{luck} can be formally defined and measured
through a multi-component framework that integrates 
...
This formalization enables quantitative analysis while preserving philosophical
distinctions between different forms of luck.

The framework addresses three interconnected problems. 
