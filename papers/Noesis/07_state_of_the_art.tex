...
% TODO(ai_gp): Add a quadrant/landscape figure plotting the six clusters of
% Table~\ref{tab:sota_comparison} (e.g., auction-based price discovery on
% one axis, bundled+metered quality on the other), with Noesis marked as
% the point occupying the combination no surveyed cluster reaches.
