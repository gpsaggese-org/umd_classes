...
%   Reveal [label="reveal window\nbidders disclose (bid, salt)", fillcolor="#A6E7F4"];
...
%   Locked [label="locked\n(matched into contract κ)", fillcolor="#A6E7F4"];
