...
\end{example}
% TODO(ai_gp): Add a figure explaining this
...
% TODO(ai_gp): Add some arrows from bottom and top representing bids and asks,
% in the yellow box
...
% TODO(ai_gp): Smaller and also rotate the figure to put bids at the bottom and
% ask at the top
...
% TODO(ai_gp): Add a figure showing the cumulative demand curve $D(p)$
...
% TODO(ai_gp): Use a flow chart like diagram
