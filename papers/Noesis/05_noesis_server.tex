...
Figure~\ref{fig:request_path} traces this path end to end: the caller's request
is proxied to a provider and the response streamed back, and on the way back,
...
% caption=Path of a single request through \NoesisServer{}.
% rendered_images:end
% render_images:begin
\begin{figure}[H]
...
% TODO(ai_gp): In the routing show 3 provider and something looking like a demux
...
% TODO(ai_gp): Use a different term for distillation (this needs to be opt-in
% by customers and anonymized, one can get better rate for opt-in)
...
%   // ---------------------------------------------------------------
%   // House style — soft/rounded palette
%   // ---------------------------------------------------------------
%   bgcolor="transparent";
%   pad="0.06";
%   splines=spline;
