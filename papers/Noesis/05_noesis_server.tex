...
request is proxied to a provider and the response streamed back, and on
the way back, the request is logged as the tuple (prompt, response,
provider, model, latency, cost, contract-or-$\bot$) described above.
