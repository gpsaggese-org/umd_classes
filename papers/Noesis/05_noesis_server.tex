...
%   Log      [label="Log:\n(prompt, response, provider, model,\nlatency, cost, contract-or-bottom)",
%             shape=note, fillcolor="#F0E6FF"];
% 
%   Caller -> Gateway [label="request", penwidth=1.5, color="#7B8794"];
%   Gateway -> Provider [label="request", penwidth=1.5, color="#7B8794"];
...
%   Cost      [label="Net saving only if:\nestimator cost + expected routed cost\n< always-strong-model cost",
%              shape=note, fillcolor="#F0E6FF"];
% 
%   Prompt -> Estimator [penwidth=1.5, color="#7B8794"];
%   Estimator -> Tier [penwidth=1.5, color="#7B8794"];
...
% 
%   node [shape=box, style="rounded,filled", fontname="Helvetica",
%         fontsize=12, penwidth=1.2, margin="0.18,0.10", height=0.45,
%         color="#7B8794"];
%   edge [color="#9AA5B1", penwidth=1.1, arrowsize=0.75,
%         fontname="Helvetica", fontsize=10, fontcolor="#616E7C"];
% 
...
% 
%   Traffic -> Agreement [penwidth=1.5, color="#7B8794"];
%   Agreement -> Estimator;
%   Traffic -> Corpus [penwidth=1.5, color="#7B8794"];
%   Corpus -> Distill;
% }
% ```
