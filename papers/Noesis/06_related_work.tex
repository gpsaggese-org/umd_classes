...
% \draw[->, >=stealth, thick] (0,0) -- (9.4,0) node[right, font=\footnotesize, align=left] {auction-based\\price discovery};
% \draw[->, >=stealth, thick] (0,0) -- (0,7.3) node[above, font=\footnotesize, align=center] {metered, verifiable\\fulfillment};
% \draw[dashed, gray] (4.5,-0.3) -- (4.5,7.3);
% \draw[dashed, gray] (-0.3,3.5) -- (9.4,3.5);
% \node[font=\footnotesize] at (2.2,-0.5) {no};
% \node[font=\footnotesize] at (7.0,-0.5) {yes};
% \node[font=\footnotesize] at (-0.55,1.6) {no};
% \node[font=\footnotesize] at (-0.55,5.6) {yes};
% \filldraw[ptcolor] (1.1,0.9) circle (2.4pt);
% \node[align=center, font=\footnotesize] at (1.1,1.8) {LLM routing \& fusion\\(RouteLLM, FrugalGPT,\\self-consistency, MoA)};
% \filldraw[ptcolor] (7.3,0.9) circle (2.4pt);
% \node[align=center, font=\footnotesize] at (7.3,1.8) {auction theory\\(McAfee, Budish,\\Myerson)};
% \filldraw[ptcolor] (3.9,0.9) circle (2.4pt);
% \node[align=center, font=\footnotesize] at (3.9,0.15) {decentralized exchange\\(Tulip, Uniswap)};
% \filldraw[ptcolor] (7.2,5.4) circle (2.4pt);
% \node[align=right, font=\footnotesize] at (6.6,6.0) {commodity \& capacity\\markets (electricity)};
% \filldraw[noesiscolor] (8.8,6.6) circle (3pt);
% \node[align=left, font=\footnotesize\bfseries, text=noesiscolor] at (8.5,7.05) {Noesis};
% ```
