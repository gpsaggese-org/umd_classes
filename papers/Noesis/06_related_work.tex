...
% TODO(ai_gp): Add a 2x2 landscape figure positioning Noesis against the
% academic work surveyed above along two axes, e.g. auction-based price
% discovery (yes/no) versus metered, verifiable fulfillment (yes/no), to
% show visually where each related line of work sits relative to Noesis.
