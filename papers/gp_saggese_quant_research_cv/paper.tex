...
% ------------------------------------------------------------------------------
  ...
  \begin{itemize}
    \item Joined as the \textit{second person} in the alternative data group in Berkeley
...
% ------------------------------------------------------------------------------
  ...
  \begin{itemize}
    ...
    \item \textit{Research hit rate $\approx$ 50\%} (2-3 data sets didn't
      pan out)
...
% ------------------------------------------------------------------------------
  ...
  \begin{itemize}
    ...
    \item \textit{1B USD} assets under management (AUM)

    \item \textit{25\%} of risk allocated to alternative data
...
% ------------------------------------------------------------------------------
  ...
  \begin{center}
    ...
    \textit{Daily US equity strategy cumulative performance}
...
% ------------------------------------------------------------------------------
  ...
  \begin{center}
    ...
    \textit{Intraday equity strategy performance and drawdowns}
