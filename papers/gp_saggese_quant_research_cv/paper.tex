...
% ==============================================================================
  ...
  \begin{itemize}
    \item alpha signal backtesting frameworks
    \item portfolio optimization systems
  ...
  universities) to over 800 students, since 2020

  \textbf{As an academic researcher} at the University of Maryland I've focused
  on Bayesian statistics and causal AI, specifically developing methods to:
  ...
  I have successfully applied these methodologies to
  \begin{itemize}
  ...
  and I have shown that they consistently improve both accuracy and robustness
...
% ==============================================================================
  ...
  My research foundation in causal AI and Bayesian Statistics at the University
  of Maryland, and applied work at Causify.AI, informs my approach to
