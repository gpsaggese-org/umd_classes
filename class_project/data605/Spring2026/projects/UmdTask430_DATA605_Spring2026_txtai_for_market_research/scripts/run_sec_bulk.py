...
def parse_args() -> argparse.Namespace:
    ...
    # ── Storage flags
    parser.add_argument(
        "--no-cold", action="store_true", help="Skip MinIO cold storage"
    )
    parser.add_argument(
        "--no-warm", action="store_true", help="Skip PostgreSQL warm storage"
    )
    parser.add_argument(
        "--no-search", action="store_true", help="Skip txtai search index"
    )
